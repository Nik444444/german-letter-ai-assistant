        ...
        {!analysis ? (
          ...
          <div className="max-w-5xl mx-auto animate-fade-in">
            <div className={`bg-white/80 backdrop-blur-md rounded-3xl shadow-2xl ${cardPadding} border border-white/20 relative overflow-hidden`}>
              {/* Background pattern */}
              <div className="absolute inset-0 opacity-5">
                <div className="absolute inset-0 bg-gradient-to-br from-green-500 to-blue-500 transform rotate-45 scale-150"></div>
              </div>
              
              <div className="relative z-10">
                <div className={`flex ${isMobile ? 'flex-col space-y-4' : 'justify-between items-center'} mb-6`}>
                  <div className="flex items-center">
                    <div className="flex items-center justify-center w-12 h-12 bg-gradient-to-r from-green-400 to-blue-400 rounded-full mr-3 animate-pulse">
                ...
                <div className="space-y-6">
                  {/* Summary */}
                  <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-6 border border-blue-200 shadow-lg transform hover:scale-102 transition-transform duration-300">
                    <div className="flex items-center mb-3">
                      <div className="flex items-center justify-center w-8 h-8 bg-gradient-to-r from-blue-400 to-indigo-400 rounded-full mr-3">
                        <svg className="w-4 h-4 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                        </svg>
                      </div>
                      <h3 className="text-lg font-bold text-blue-900">{t.summary}</h3>
                    </div>
                    <p className="text-blue-800 leading-relaxed">{analysis.analysis.summary}</p>
                  </div>

                  {/* Basic Info Grid */}
                  <div className={`grid ${isMobile ? 'grid-cols-1' : 'md:grid-cols-2'} gap-4`}>
                    <div className="bg-gradient-to-r from-purple-50 to-pink-50 rounded-2xl p-4 border border-purple-200 shadow-lg transform hover:scale-102 transition-transform duration-300">
                      <div className="flex items-center mb-2">
                        <div className="flex items-center justify-center w-6 h-6 bg-gradient-to-r from-purple-400 to-pink-400 rounded-full mr-2">
                          <svg className="w-3 h-3 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                          </svg>
                        </div>
                        <h4 className="text-sm font-bold text-purple-900">{t.sender}</h4>
                      </div>
                      <p className="text-purple-800 text-sm font-medium">{analysis.analysis.sender || 'N/A'}</p>
                    </div>
                    <div className="bg-gradient-to-r from-green-50 to-teal-50 rounded-2xl p-4 border border-green-200 shadow-lg transform hover:scale-102 transition-transform duration-300">
                      <div className="flex items-center mb-2">
                        <div className="flex items-center justify-center w-6 h-6 bg-gradient-to-r from-green-400 to-teal-400 rounded-full mr-2">
                          <svg className="w-3 h-3 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zM21 5a2 2 0 00-2-2h-4a2 2 0 00-2 2v12a4 4 0 004 4h4a2 2 0 002-2V5z" />
                          </svg>
                        </div>
                        <h4 className="text-sm font-bold text-green-900">{t.letterType}</h4>
                      </div>
                      <p className="text-green-800 text-sm font-medium">{analysis.analysis.letter_type || 'N/A'}</p>
                    </div>
                  </div>

                  {/* Main Content */}
                  <div className="bg-gradient-to-r from-yellow-50 to-orange-50 rounded-2xl p-6 border border-yellow-200 shadow-lg transform hover:scale-102 transition-transform duration-300">
                    <div className="flex items-center mb-3">
                      <div className="flex items-center justify-center w-8 h-8 bg-gradient-to-r from-yellow-400 to-orange-400 rounded-full mr-3">
                        <svg className="w-4 h-4 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                        </svg>
                      </div>
                      <h4 className="text-lg font-bold text-yellow-900">{t.mainContent}</h4>
                    </div>
                    <p className="text-yellow-800 leading-relaxed">{analysis.analysis.main_content}</p>
                  </div>

                  {/* Urgency Level */}
                  {analysis.analysis.urgency_level && (
                    <div className="bg-white rounded-2xl p-4 border shadow-lg">
                      <div className="flex items-center mb-2">
                        <div className="flex items-center justify-center w-6 h-6 bg-gradient-to-r from-red-400 to-pink-400 rounded-full mr-2">
                          <svg className="w-3 h-3 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4c-.77-.833-1.964-.833-2.732 0L3.732 16.5c-.77.833.192 2.5 1.732 2.5z" />
                          </svg>
                        </div>
                        <h4 className="text-sm font-bold text-gray-900">{t.urgencyLevel}</h4>
                      </div>
                      <span className={`px-4 py-2 rounded-2xl text-sm font-bold border-2 ${getUrgencyColor(analysis.analysis.urgency_level)} inline-block transform hover:scale-105 transition-transform duration-300`}>
                        {t.urgencyLevels[analysis.analysis.urgency_level] || analysis.analysis.urgency_level}
                      </span>
                    </div>
                  )}

                  {/* Actions, Deadlines, Documents Grid */}
                  <div className={`grid ${gridClass} gap-4`}>
                    {/* Actions Needed */}
                    {analysis.actions_needed && analysis.actions_needed.length > 0 && (
                      <div className="bg-gradient-to-r from-red-50 to-pink-50 rounded-2xl p-4 border border-red-200 shadow-lg transform hover:scale-102 transition-transform duration-300">
                        <div className="flex items-center mb-3">
                          <div className="flex items-center justify-center w-6 h-6 bg-gradient-to-r from-red-400 to-pink-400 rounded-full mr-2">
                            <svg className="w-3 h-3 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          ...
                          <h4 className="text-sm font-bold text-red-900">{t.actionsNeeded}</h4>
                        </div>
                        <ul className="space-y-2">
                          {analysis.actions_needed.map((action, index) => (
                            <li key={index} className="flex items-start">
                              ...
                              <span className="text-red-800 text-sm font-medium">{action}</span>
                            </li>
                          ))}
                        </ul>
                      </div>
                    ...
                    {analysis.deadlines && analysis.deadlines.length > 0 && (
                      <div className="bg-gradient-to-r from-orange-50 to-red-50 rounded-2xl p-4 border border-orange-200 shadow-lg transform hover:scale-102 transition-transform duration-300">
                        <div className="flex items-center mb-3">
                          <div className="flex items-center justify-center w-6 h-6 bg-gradient-to-r from-orange-400 to-red-400 rounded-full mr-2">
                            <svg className="w-3 h-3 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                            </svg>
                          </div>
                          <h4 className="text-sm font-bold text-orange-900">{t.deadlines}</h4>
                        </div>
                        <ul className="space-y-2">
                          {analysis.deadlines.map((deadline, index) => (
                            <li key={index} className="flex items-start">
                              <span className="flex items-center justify-center w-5 h-5 bg-orange-100 rounded-full mr-2 mt-0.5 flex-shrink-0">
                                <svg className="w-2 h-2 text-orange-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                                </svg>
                              </span>
                              <span className="text-orange-800 text-sm font-medium">{deadline}</span>
                            </li>
                          ))}
                        </ul>
                      </div>
                    ...
                    {/* Documents Required */}
                    {analysis.analysis.documents_required && analysis.analysis.documents_required.length > 0 && (
                      <div className="bg-gradient-to-r from-indigo-50 to-purple-50 rounded-2xl p-4 border border-indigo-200 shadow-lg transform hover:scale-102 transition-transform duration-300">
                        <div className="flex items-center mb-3">
                          <div className="flex items-center justify-center w-6 h-6 bg-gradient-to-r from-indigo-400 to-purple-400 rounded-full mr-2">
                            <svg className="w-3 h-3 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                            </svg>
                          </div>
                          <h4 className="text-sm font-bold text-indigo-900">{t.documentsRequired}</h4>
                        </div>
                        <ul className="space-y-2">
                          {analysis.analysis.documents_required.map((doc, index) => (
                            <li key={index} className="flex items-start">
                              <span className="flex items-center justify-center w-5 h-5 bg-indigo-100 rounded-full mr-2 mt-0.5 flex-shrink-0">
                                <svg className="w-2 h-2 text-indigo-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                                </svg>
                              </span>
                              <span className="text-indigo-800 text-sm font-medium">{doc}</span>
                            </li>
                          ))}
                        </ul>
                      </div>
                  ...
                  {analysis.analysis.consequences && (
                    <div className="bg-gradient-to-r from-gray-50 to-slate-50 rounded-2xl p-6 border border-gray-200 shadow-lg transform hover:scale-102 transition-transform duration-300">
                      <div className="flex items-center mb-3">
                        <div className="flex items-center justify-center w-8 h-8 bg-gradient-to-r from-gray-400 to-slate-400 rounded-full mr-3">
                          <svg className="w-4 h-4 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4c-.77-.833-1.964-.833-2.732 0L3.732 16.5c-.77.833.192 2.5 1.732 2.5z" />
                          </svg>
                        </div>
                        <h4 className="text-lg font-bold text-gray-900">{t.consequences}</h4>
                      </div>
                      <p className="text-gray-800 leading-relaxed">{analysis.analysis.consequences}</p>
                    </div>
                  )}

                  {/* Response Template */}
                  {analysis.response_template && (
                    <div className="bg-gradient-to-r from-emerald-50 to-teal-50 rounded-2xl p-6 border border-emerald-200 shadow-lg transform hover:scale-102 transition-transform duration-300">
                      <div className="flex items-center mb-3">
                        <div className="flex items-center justify-center w-8 h-8 bg-gradient-to-r from-emerald-400 to-teal-400 rounded-full mr-3">
                          <svg className="w-4 h-4 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                          </svg>
                        </div>
                        <h4 className="text-lg font-bold text-emerald-900">{t.responseTemplate}</h4>
                      </div>
                  ...
                  {analysis.llm_provider && (
                    <div className="bg-gradient-to-r from-cyan-50 to-blue-50 rounded-2xl p-4 border border-cyan-200 shadow-lg transform hover:scale-102 transition-transform duration-300">
                      <div className="flex items-center mb-2">
                        <div className="flex items-center justify-center w-6 h-6 bg-gradient-to-r from-cyan-400 to-blue-400 rounded-full mr-2">
                          <svg className="w-3 h-3 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />
                          </svg>
                        </div>
                        <h4 className="text-sm font-bold text-cyan-900">{t.llmProvider}</h4>
                      </div>
                      <div className="flex items-center">
